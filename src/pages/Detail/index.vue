          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{active:spuSalAttrValue.isChecked === '1'}" v-for="spuSalAttrValue in spuSaleAttr.spuSaleAttrValueList" :key="spuSalAttrValue.id" @click="changeActive(spuSalAttrValue,spuSaleAttr.spuSaleAttrValueList)">{{spuSalAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
  ...
  methods: {
    ...
    async addShopCar() {
      try {
        ...
        sessionStorage.setItem('SPULIST', JSON.stringify(this.spuSaleAttrList))
        // 路由跳转 将产品信息带上
        this.$router.push({
          name: 'addcartsuccess',
          query: {
